namespace QuizzGenerator.Domain.Migrations
{
    ...
    public partial class initDataBase : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                "dbo.QuestionOptionResults",
                c => new
                    {
                        QuestionOption_AnswerId = c.Int(nullable: false),
                        Result_ResultId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => new { t.QuestionOption_AnswerId, t.Result_ResultId })
                .ForeignKey("dbo.QuestionOption", t => t.QuestionOption_AnswerId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.QuestionOptionResults", "Result_ResultId", "dbo.Result");
            DropForeignKey("dbo.QuestionOptionResults", "QuestionOption_AnswerId", "dbo.QuestionOption");
            ...
            DropForeignKey("dbo.QuizQuestions", "Question_QuestionId", "dbo.Question");
            DropForeignKey("dbo.QuizQuestions", "Quiz_QuizId", "dbo.Quiz");
            ...
            DropIndex("dbo.QuestionOptionResults", new[] { "QuestionOption_AnswerId" });
            ...
            DropTable("dbo.QuestionOptionResults");
